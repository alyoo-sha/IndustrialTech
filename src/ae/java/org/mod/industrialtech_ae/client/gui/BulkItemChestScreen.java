...
public class BulkItemChestScreen extends AbstractContainerScreen<BulkItemChestMenu> {
    ...
    protected void init() {
        ...
        this.elements.add(new TextElement(FILTER_RECT, () -> (this.menu).getFilter() == null ? Component.translatable("gui.industrialtech_ae.no_filter").withStyle(ChatFormatting.RED) : Component.translatable("gui.industrialtech_ae.contains").withStyle(ChatFormatting.GRAY).append(Component.literal(": ").withStyle(ChatFormatting.GRAY)).append((this.menu).getFilter().getDisplayName().copy().withStyle(ChatFormatting.GREEN)), 11184810, false, TextAlignment.LEFT, () -> (this.menu).getFilter() != null ? Collections.singletonList((this.menu).getFilter().getDisplayName().copy().withStyle(ChatFormatting.GREEN)) : null));
        this.elements.add(new TextElement(AMOUNT_RECT, () -> (this.menu).getItem() != null && (this.menu).getAmount() != 0L ? Component.translatable("gui.industrialtech_ae.amount").withStyle(ChatFormatting.GRAY).append(Component.literal(": ").withStyle(ChatFormatting.GRAY)).append(AmountFormatter.formatItem((this.menu).getAmount(), true, ChatFormatting.AQUA)) : Component.translatable("gui.industrialtech_ae.empty").withStyle(ChatFormatting.DARK_RED), 11184810, false, TextAlignment.LEFT, () -> (this.menu).getItem() != null && (this.menu).getAmount() >= 0L ? Collections.singletonList(AmountFormatter.formatWithSpaces((this.menu).getAmount(), ChatFormatting.AQUA)) : null));
        ...
        BulkItemChestMenu var10004 = this.menu;
        Objects.requireNonNull(var10004);
        var10000.add(new ItemSlotElement(var10003, var10004::getFilter, () -> (this.menu).getFilter() != null ? Collections.singletonList((this.menu).getFilter().getDisplayName().copy().withStyle(ChatFormatting.GREEN)) : Collections.singletonList(Component.translatable("gui.industrialtech_ae.no_filter").withStyle(ChatFormatting.RED)), 0, (button) -> AEModNetworking.sendToServer(new ItemFilterInteractPacket((this.menu).getBlockPos()))));
        this.elements.add(new ItemSlotElement(ITEM_SLOT_RECT, () -> (this.menu).getAmount() > 0L ? (this.menu).getItem() : null, () -> (this.menu).getItem() != null && (this.menu).getAmount() > 0L ? List.of((this.menu).getItem().getDisplayName().copy().withStyle(ChatFormatting.GREEN), AmountFormatter.formatItem((this.menu).getAmount(), true, ChatFormatting.AQUA)) : Collections.singletonList(Component.translatable("gui.industrialtech_ae.empty").withStyle(ChatFormatting.DARK_RED)), -1, (button) -> AEModNetworking.sendToServer(new ItemInteractPacket((this.menu).getBlockPos(), button == 1))));
    }

    private boolean isCustomTooltipArea(int mouseX, int mouseY) {
        return FILTER_SLOT_RECT.contains(mouseX, mouseY, this.leftPos, this.topPos) || ITEM_SLOT_RECT.contains(mouseX, mouseY, this.leftPos, this.topPos);
    }
