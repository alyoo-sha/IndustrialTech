...
public class AEModTab {
    ...
    public static final RegistryObject<CreativeModeTab> AE2_BULK_TAB1 =
            CREATIVE_MODE_TABS.register("ae2_bulk_cells", () -> CreativeModeTab.builder()
                    ...
                    .icon(() -> new ItemStack( AEModItem.BULK_FLUID_CELL.get()))
                    .displayItems((params, output) -> {
                        output.accept(AEModItem.INFINITE_PATTERN.get());
                        output.accept(AEModItem.BULK_COMPONENT.get());
                        output.accept(AEModItem.BULK_ITEM_CELL.get());
                        output.accept(AEModBlock.BULK_ITEM_CHEST.get());
                        output.accept(AEModItem.BULK_FLUID_CELL.get());
                        output.accept(AEModBlock.BULK_FLUID_TANK.get());
